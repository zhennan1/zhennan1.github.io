...
* **Scaling External Knowledge Input Beyond Context Windows of LLMs via Multi-Agent Collaboration**  
  ...
  *arXiv 2025*. In submission to *NeurIPS 2025*. [[Paper](https://arxiv.org/abs/2505.21471)] [[GitHub](https://github.com/THUNLP-MT/ExtAgents)] [[Data](https://huggingface.co/datasets/zhennan1/ExtAgents)]  
  \*Equal contribution.
